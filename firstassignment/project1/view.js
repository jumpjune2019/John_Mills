		...
		this.triggerField = function() {
			var html = [
				"<div class='triggerContainerWrap'>",
					"<input type='text' id='test' placeholder='Add items' class='triggerText'></input>",
					"<button type='button' id='addBtn' class='triggerButton'>Add</button>",
				"</div>"
			].join("");
			...
			var constructor = function() {
				...
				this.getTextInstance = function(contextEl) {
					//console.log(contextEl.getElementsByClassName('triggerText'[0]));
